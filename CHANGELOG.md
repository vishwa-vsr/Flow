...
### Changed
- **Top Sites Actions Column Realignment**: Shifted the `ACTIONS` segment (Pin, Open Link, Shield icons) in the Top Sites table rightward (`justify-content: flex-end`) right next to the Category dropdown column with balanced grid template spacing (`minmax(140px, 1fr) 110px 170px 75px 75px`), preventing any icon overlap with domain names or category pills.
