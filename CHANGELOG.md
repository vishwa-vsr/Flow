...
- **Support links:** Added direct links to rate the extension on the Chrome Web Store and to read the online changelog inside the Support & Feedback settings panel.
