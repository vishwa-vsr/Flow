<div align="center">
  <img src="icons/icon128.png" width="96" height="96" alt="Flow Logo">
  <h1>Flow</h1>
  ...
  <p>
    ...
    <a href="https://microsoftedge.microsoft.com/addons/detail/jlcdkibfogehgkbhkkkglifbanenkmic"><img src="https://developer.microsoft.com/store/badges/images/English_get-it-from-MS.png" alt="Get it from Microsoft" height="40"></a>
    <a href="https://addons.mozilla.org/en-US/firefox/addon/flow-website-blocker/"><img src="https://blog.mozilla.org/addons/files/2020/04/get-the-addon-fx-apr-2020.svg" alt="Get the add-on" height="40"></a>
  </p>
  ...
  <p><i>Formerly known as FocusFlow. Latest Release: <b>v10.0.1</b></i></p>

  <br>
  
  <img src="flow_preview1.jpg" width="100%" alt="Flow Overview Banner" style="border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
</div>
...
<div align="center">
  ...
  <img src="flow_preview4.jpg" width="90%" alt="Focus Mode and Schedules" style="border-radius: 8px;">

  <br><br>

  <h3>📊 Detailed Daily Analytics & Consistency Heatmap</h3>
  <img src="flow_preview2.jpg" width="90%" alt="Detailed Daily Analytics" style="border-radius: 8px;">

  <br><br>

  <h3>🚫 Smart Site Blocker (Rules & Redirects)</h3>
  <img src="flow_preview3.jpg" width="90%" alt="Block and Allow Rules" style="border-radius: 8px;">

  <br><br>

  <h3>⚙️ Personalization, Themes & Backups</h3>
  <img src="flow_preview5.jpg" width="90%" alt="Personalize Workspace" style="border-radius: 8px;">
</div>
...
5. Select the `flow-source` folder from the files you downloaded.
...
4. Run the build script:
   ...
   npm run build
   ```
   *(Note: To package the target folders into `.zip` archives for store uploads, run `npm run zip` instead. The script will ask you if you want to bump the version number. Bypassing prompts can be done via the `-y` flag, e.g., `npm run build -- --skip-prompt`.)*
...
* The build script (`build.js`) does **not** rely on complex bundlers.
